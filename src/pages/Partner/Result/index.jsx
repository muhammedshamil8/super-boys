...
function index() {
    return (
        ...
        >
            ...
            <div className="p-4">
                <div className="rounded-3xl min-h-[400px] border shadow-lg bg-white px-6 border-[#FC771D] relative max-w-[800px] mx-auto mt-10 flex flex-col">
                    <h1 className="text-2xl font-bold text-[#FC771D] text-center py-4">Sorry</h1>
