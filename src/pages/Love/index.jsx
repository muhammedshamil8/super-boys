  ...
  return (
    ...
    >
      <div className="relative w-full h-full">
        <img src={Love_Calculator} alt="background" className="w-full min-h-[300px] max-h-[1200px] object-cover" />
        <div className='absolute inset-0  opacity-50' />
        <div className='absolute min-h-14 bottom-0 bg-white/50  w-full left-0 right-0 text-center rounded-t-3xl' >
          <h1 className="text-2xl md:text-4xl font-bold text-white z-10 py-6 md:py-10 text-shadow">Love Calculator</h1>
        </div>
      ...
      <div className='p-4 pb-20 mt-10'>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className='rounded-3xl border shadow-lg bg-white p-4 px-6 border-[#C0034D] max-w-[900px] mx-auto py-10 space-y-6'>
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 gap-x-8'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[#A40744]">Your Name</FormLabel>
                      <FormControl>
                        <Input className="border-[#ED025D]/50 focus-visible:border-[#ED025D]" placeholder="shadcn" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col justify-end w-full">
                      <FormLabel className="text-[#A40744] font-semibold">Date of birth</FormLabel>
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
                              variant={"outline"}
                              className={cn(
                                "w-full bg-[#D9D9D9]/30 border-[#ED025D]/50 focus-visible:border-[#ED025D] text-left font-normal",
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 gap-x-8'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[#A40744]">Your Lover Name</FormLabel>
                      <FormControl>
                        <Input className="border-[#ED025D]/50 focus-visible:border-[#ED025D]" placeholder="shadcn" {...field} />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col justify-end w-full">
                      <FormLabel className="text-[#A40744] font-semibold">Partners' Date of birth</FormLabel>
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
